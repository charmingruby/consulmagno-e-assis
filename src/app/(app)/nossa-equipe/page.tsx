      ...
      <Container.Root border="borderBottom">
        <Container.Content>
          <div className='max-w-2xl mx-auto text-center flex flex-col items-center'>
            ...
            <Text className='mt-4'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ea eos accusantium ducimus aspernatur totam possimus asperiores! Exercitationem nemo eveniet, ea similique autem, quisquam doloremque mollitia, beatae tempore ipsa totam officiis!</Text>
          </div>
