...
export function Dropdown({ label, links }: DropdownProps) {
  return (
    <Menu as="div" className="relative inline-block text-left">
      <div>
        <Menu.Button className="inline-flex w-full justify-center bg-opacity-20 px-4 py-2 focus:outline-none font-medium group items-center border-b-2 border-gray-75 h-[3.75rem] transition-colors hover:border-primary-main cursor-pointer">
